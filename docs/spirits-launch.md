...
The initial live trial rejected the Chat Completions configuration; this corrected transport follows the [Astra migration guide](https://developers.openai.com/api/docs/guides/latest-model?model=gpt-6-astra).
